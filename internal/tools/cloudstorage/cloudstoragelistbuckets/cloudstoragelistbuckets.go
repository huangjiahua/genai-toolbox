...
type compatibleSource interface {
	ListBuckets(ctx context.Context, prefix string, maxResults int, pageToken string) (map[string]any, error)
}
...
func (cfg Config) Initialize(srcs map[string]sources.Source) (tools.Tool, error) {
	...
	maxResultsParam := parameters.NewIntParameterWithDefault(maxResultsKey, 0, "Maximum number of buckets to return per page. A value of 0 uses the API default (1000); the maximum allowed is 1000.")
	...
	params := parameters.Parameters{prefixParam, maxResultsParam, pageTokenParam}
...
func (t Tool) Invoke(ctx context.Context, resourceMgr tools.SourceProvider, params parameters.ParamValues, accessToken tools.AccessToken) (any, util.ToolboxError) {
	...
	resp, err := source.ListBuckets(ctx, prefix, maxResults, pageToken)
	if err != nil {
